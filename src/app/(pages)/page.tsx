            ...
            {[
              {
                ...
                description:
                  "All tours are carefully planned with safety protocols in place. We partner only with licensed, insured service providers and have 24/7 emergency response teams.",
              },
              {
                icon: "/icons/cell-phone.png",
                title: "Regular Parent Updates",
                description:
                  "We keep you informed throughout the trip with real-time updates, messages, and photos so you always know where your child is and what they're doing.",
              },
              {
                icon: "/icons/health-medical-support.png",
                title: "Health & Medical Support",
                description:
                  "We're prepared for any health-related needs, with access to medical professionals, first aid, and immediate support if required",
              },
              {
                icon: "/icons/age-appropriate.png",
                title: "Curated, Age-Appropriate Itineraries",
                description:
                  "Every destination and activity is chosen with student interests and safety in mind—engaging, enriching, and 100% age-appropriate.",
              },
              {
                icon: "/icons/transparent-communication.png",
                title: "Transparent Communication",
                description:
                  "No surprises. Parents receive complete tour plans, safety procedures, and emergency contact information well in advance.",
              },
              {
                icon: "/icons/insurance-coverage.png",
                title: "Insurance Coverage",
                description:
                  "Each student is covered under a comprehensive travel insurance plan for added peace of mind.",
              },
            ].map(({ icon, title, description }, index) => (
              <Card
                key={index}
                className="xl:px-12 md:px-8 px-4 flex flex-row items-start gap-x-4 !rounded-3xl"
              >
