...
export default function aboutus() {
    ...
    {
        heading: "Our Story",
        description: ["It all started with a simple idea: what if learning could be fun—and happen anywhere in the world?",
        ...
        list: [],
        className: {
            mainCss: "flex-row-reverse blueBackgroundGradientColor rounded-4xl px-4",
    ...
    },
    {
        ...
        description: ["We’re a small but mighty crew of travel pros, safety experts, and youth leaders who care deeply about student experiences. We plan every detail, guide every step, and keep the energy high (and the fun even higher).",
