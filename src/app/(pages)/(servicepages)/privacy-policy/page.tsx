...
export default function page() {
  ...
  return (
    <div className="container py-20">
      ...
      <article>
        <div className="pt-10">
          <h1 className="primary-red text-2xl md:text-4xl py-5">
          ...
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Personal Information:</strong> Full
            name, date of birth, gender, nationality, passport details, email
          ...
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Payment and Billing Info:</strong>{" "}
            Credit/debit card details and billing addresses (collected through
            secure third-party services).
          </p>
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Website Usage Data:</strong> IP
            address, browser type, device information, and site interactions
            collected via cookies and analytics tools.
          </p>
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Photos and Videos:</strong> Images
            captured during tours may be used for promotional content, with
            prior consent.
          </p>
        </div>
      </article>
      <article>
        <div>
          ...
          <p className="text-xl md:text-2xl pb-5">
          ...
          {paragraphs.map((text, index) => (
            <p
              key={index}
              className="flex gap-2 items-start text-xl md:text-2xl pb-3"
            >
              <Image
                width={24}
                height={24}
      ...
      <article>
        <div>
          ...
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Travel Vendors: </strong> Airlines,
            hotels, local guides, and transport providers, to ensure your trip
            is booked and managed properly.
          </p>
          <p className="text-xl md:text-2xl pb-4">
            <strong className="primary-blue">Medical Personnel: </strong>In case
            of an emergency, we may share relevant health data with healthcare
            providers.
          </p>
          <p className="text-xl md:text-2xl pb-4">
