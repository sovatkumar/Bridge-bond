...
export default function page() {
  ...
  return (
    <div className='container py-20 px-4'>
      <div className="grid grid-cols-1 md:grid-cols-3 justify-center gap-10 px-4">
      ...
      <div className='flex w-full justify-center shadow-sm p-5 rounded-4xl'>
        <Form {...form}>
          <form
          ...
          >
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-3 text-[#000302]">
                <Checkbox id="terms" />
                <Label htmlFor="terms" className='text-lg'>Keep me updated on the latest Contiki news, deals and latest trips. You can unsubscribe at any time.</Label>
              </div>
              <div className="flex items-center gap-3">
                <Checkbox id="terms-2" />
                <div className="grid gap-2 text-[#000302]">
                  <Label htmlFor="terms-2" className='text-lg'>By checking this box, you accept our privacy policy *</Label>
                </div>
              </div>
