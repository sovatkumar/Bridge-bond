  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        {/* Icon Swap using data-state */}
        <span className="pointer-events-none size-6 md:size-8 shrink-0 translate-y-0.5">
          <Plus className="block data-[state=open]:hidden" />
          <Minus className="hidden data-[state=open]:block" />
        </span>
      </AccordionPrimitive.Trigger>
